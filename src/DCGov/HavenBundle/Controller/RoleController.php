...
use DCGov\HavenBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $roles = $em->getRepository('DCGovHavenBundle:Role')->findAll();
    ...
    {
        $role = new Role();
        $form = $this->createForm('DCGov\HavenBundle\Form\RoleType', $role);
    ...
    {
        $deleteForm = $this->createDeleteForm($role);
        $editForm = $this->createForm('DCGov\HavenBundle\Form\RoleType', $role);
